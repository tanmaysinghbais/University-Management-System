...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/3.jpg"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("New Student Admission")){
            ...
            try{
                Runtime.getRuntime().exec("C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome");
            }catch(Exception e){ }
